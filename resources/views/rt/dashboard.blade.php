...
@section('content')
    <nav class="navbar bg-white border-bottom">
        <div class="container">
            <a class="navbar-brand fw-semibold" href="{{ route('rt.dashboard') }}">SIGAP WARGA — RT</a>
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body p-4">
                <div class="d-flex flex-wrap justify-content-between gap-3 mb-3">
                    <h1 class="h3 mb-0">Laporan Terbaru</h1>
                    <form method="GET" action="{{ route('rt.dashboard') }}" class="row g-2">
                        <div class="col-auto">
                        ...
                        <div class="col-auto">
                            <input name="search" value="{{ request('search') }}" class="form-control" placeholder="Tiket, warga, atau judul">
                        </div>
                ...
                <div class="table-responsive">
                    <table class="table table-hover align-middle">
                        <thead><tr><th>Tiket</th><th>Warga</th><th>Judul</th><th>Status</th><th>Tanggal</th><th></th></tr></thead>
                        <tbody>
                            @forelse ($reports as $report)
                                <tr>
                                    ...
                                    <td><a class="btn btn-outline-primary btn-sm" href="{{ route('rt.reports.show', $report) }}">Detail</a></td>
                                </tr>
                            @empty
