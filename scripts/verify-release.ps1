...
$environmentNames = @(
    ...
    'WHATSAPP_WABA_ID', 'WHATSAPP_PHONE_NUMBER_ID', 'WHATSAPP_ACCESS_TOKEN', 'WHATSAPP_GRAPH_VERSION',
...
try {
    ...
    $env:WHATSAPP_WABA_ID = '100000000000001'
    $env:WHATSAPP_PHONE_NUMBER_ID = '100000000000002'
